...
from PAOFLOW_QTpy.io.log_module import log_push
...
#             raise ValueError("Invalid value for transport_dir. Allowed values are 1,2 or 3")
#         return value
...
def read_namelist_input_conductor():
    """Need to think how to do this"""
    log_push("read_namelist_input_conductor")
